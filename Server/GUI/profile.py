...
class MainProfilePage(tk.Frame):
   ...
   def __init__(self, parent, control):
      ...
      self.img = tk.PhotoImage(file="D:\Programming_YuninDD\ITlab_Project\Server\GUI\Pictures\setting.png")
...
class SettingPage(tk.Frame):
    def __init__(self, parent, control):
        ...
        self.img = tk.PhotoImage(file="D:\Programming_YuninDD\ITlab_Project\Server\GUI\Pictures\home_page_profile.png")
        self.img = self.img.subsample(10,10)
